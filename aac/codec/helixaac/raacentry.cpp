...
{
    return RAACDecode(codecRef, in, inLength, out, pOutLength, userData);
}

HX_RESULT HXEXPORT ENTRYPOINT(RAFlush) (RACODEC codecRef, Byte* outBuf, UINT32* pOutLength)
{
    return RAACFlush(codecRef, outBuf, pOutLength);
}
